...
export function ChartTooltipContent({ children, ...props }: ChartTooltipContentProps) {
  return (
...
const ChartTooltipContentOriginal = React.forwardRef<
  HTMLDivElement,
...
ChartTooltipContentOriginal.displayName = "ChartTooltip"
